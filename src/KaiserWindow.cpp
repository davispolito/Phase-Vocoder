...
//
void
KaiserWindow::buildWindow( vector< float > & win, float shape )
{   
...
//
void
KaiserWindow::buildTimeDerivativeWindow( vector< float > & win, float shape )
{   
...
//
float
KaiserWindow::computeShape( float atten )
{
...
//
unsigned long
KaiserWindow::computeLength( float width, float alpha )
{
    //float alpha = computeShape( atten );
